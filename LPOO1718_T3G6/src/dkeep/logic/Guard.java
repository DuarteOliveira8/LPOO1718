...
public class Guard extends Character{
	 ...
	 */
	public char patrol[] = {'a','s','s','s','s','a','a','a','a','a','a','s','d','d','d','d','d','d','d','w','w','w','w','w'};
	/*
	 * array that contains all the guard's predefined movements in reverse, in case the personality is suspicious
	 */
	public char patrolreverse[] = {'s','d','w','w','w','w','d','d','d','d','d','d','w','a','a','a','a','a','a','a','s','s','s','s'};
	/*
	...
	/*
	 * when the guard's persoanlity is drunken or suspicious, determines if the guard is going to make its normals movements or go in the reverse way
	 */
